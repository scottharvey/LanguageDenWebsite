...
3. Enter a name and choose a source type
4. Tap **Save**
...
When adding a word via [Add Word](/docs/adding-words/), a **Source** picker appears at the bottom of the form (if you have at least one source set up). Select the section where you encountered the word.

When importing via [CSV](/docs/csv/) or [Anki](/docs/anki/), you can assign all imported words to a source section in the import preview screen.
