...
<div class="docs-callout docs-callout--info">
  ...
  <p>Microphone access is required for audio capture. Language Den will prompt you for permission the first time you switch to audio mode. Audio data is stored on-device and synced via iCloud — it is never sent to any server.</p>
</div>
...
2. Language Den opens the [Add Word](/docs/adding-words/) screen with the text pre-filled
...
- Use the **All** tab to see every note regardless of processing status
- Use the **Processed** tab to review notes you've already turned into words
