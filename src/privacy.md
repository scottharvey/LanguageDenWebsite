...
You can delete all data at any time by deleting the app.
...
**Unsplash API**
If you add an Unsplash API key, the app sends image search queries to the Unsplash API to find images for flashcards. Your API key is stored in the iOS Keychain on your device and is never sent to us. You are responsible for your usage under [Unsplash's Terms of Service](https://unsplash.com/terms).

These API keys are stored exclusively on your device in the iOS Keychain. We cannot see, access, or recover them.
...
We may update this policy as the app evolves. Significant changes will be noted on this page with an updated date.
